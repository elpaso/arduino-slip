...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.pushButton, 
			QtCore.SIGNAL("clicked()"), invia_arduino_on)
        QtCore.QObject.connect(self.pushButton_3, 
			QtCore.SIGNAL("clicked()"), invia_arduino_off)
        QtCore.QObject.connect(self.pushButton_2, 
			QtCore.SIGNAL("clicked()"), quit_gui)
        
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtGui.QApplication.
			translate("MainWindow", "Python QT e Arduino Esercizio uno", 
        ...
        self.lineEdit.setText(QtGui.QApplication.
			translate("MainWindow", "Prova Scrittura"
			" Programma Python Qt4", 
			None, QtGui.QApplication.UnicodeUTF8))
